...
INSERT INTO `__new_statement_ownerships`("id", "identifier", "account_id", "card_id", "updated_at", "created_at", "deleted_at") SELECT row_number() OVER (ORDER BY "statement_id") as "id", "identifier", "account_id", "card_id", "updated_at", "created_at", "deleted_at" FROM `statement_ownerships`;--> statement-breakpoint
