...
const AddForm = ({
	...
	return (
		<div
			className={`collapse collapse-arrow ${isOpen ? "collapse-open" : "collapse-close"}`}
		>
...
export const AddAccountForm = ({
	...
	const onSubmit = async (
		values: PostAccountReq,
		form: FormApi<PostAccountReq>,
	) => {
		setError("");
					...
					<form onSubmit={handleSubmit}>
						<fieldset className="fieldset bg-base-200 border-base-300 rounded-box w-xs border p-4">
							...
							<Field<string>
								name="accountType"
								component="select"
								defaultValue="Pick an account type"
								className="select"
							>
					...
					<form onSubmit={handleSubmit}>
						<fieldset className="fieldset bg-base-200 border-base-300 rounded-box w-xs border p-4">
							...
							<Field<string>
								name="cardNetwork"
								component="select"
								defaultValue="Pick a card network"
								className="select"
							>
