...
const getDataExtractorForFormat = (doc: mupdf.Document): {extractor: PdfFormatExtractor, companyName: Companies} => {
    ...
    if (firstPage.search(dbsCard.searchString).length) {
        ...
        return {extractor: chocolate.extractData, companyName: 'Chocolate_Finance'}
        ...
        return {extractor: scbCard.extractData, companyName: 'Standard_Chartered'}
        ...
        throw new HTTPException(500, {message: 'Unable to determine PDF statement format'})
    }
}
